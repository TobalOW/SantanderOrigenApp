...
export default class ModifyMaxScreen extends Component {
  render() {
    return (
        ...
        <Navbar style={{ height: 90 }}>
          <Block row flex={1} padding={10}>
            ...
            <Block flex={false} style={{ marginLeft: 15, marginTop: 3 }}>
              <Text h3 bold black>Modificar Máximo</Text>
            </Block>
          </Block>
        </Navbar>
        <Block center middle>
          <Block center middle>
            <Text size={15} black center semibold>
              Al modificar el máximo, se reemplazará automáticamente el máximo actual por el que determines.
            </Text>
          </Block>
          <Block column center middle>
            <Text center darkGray>Nuevo monto máximo</Text>
              <Input
          ...
          <Block flex={2}>
            <Button
              ...
              onPress={() => this.props.navigation.goBack()}
            >
              <Text white bold center>Confirmar máximo</Text>
            </Button>
          </Block>
        </Block>
      </View>
